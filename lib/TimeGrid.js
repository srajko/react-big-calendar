...
var TimeGrid = _react2['default'].createClass({
  ...
  renderHeader: function renderHeader(range) {
    ...
    var DayComponent = _props3.DayComponent;

    return range.map(function (date, i) {
      var onClick = _this4._headerClick.bind(null, date);
      var text = _localizer2['default'].format(date, dayFormat, culture);
      var dayLink = DayComponent ? _react2['default'].createElement(DayComponent, { onClick: onClick, text: text, date: date }) : _react2['default'].createElement(
        'a',
